...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Tambah Data Karakter</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="card pt-3">
					...
					<div class="card-body">
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input autocomplete="off" type="text" class="form-control" name="gejala_karakter">
								</div>
							</div>
							<div class="mb-3 row">
								<label for="inputPassword" class="col-sm-2 col-form-label">Karakteristik</label>
								<div class="col-sm-10">
									<input autocomplete="off" type="text" class="form-control" name="karakteristik_karakter">
								</div>
							</div>
